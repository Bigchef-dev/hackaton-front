    ...
    <div class="relative z-10">
      ...
      <div class="hidden md:grid grid-cols-1 gap-6">
        ...
        >
          ...
          <input v-model="coach.email" placeholder="Email" class="form-input" />
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <input v-model="coach.club.id" placeholder="Club ID" class="form-input" />
          </div>
      ...
      <button
        @click="addCoach"
        type="button"
        class="mt-6 text-blue-400 hover:text-blue-300 transition"
      >
        + Ajouter un coach
      </button>
